...
class FormularioMaestroDesign(tk.Tk):
    ...
    def __init__(self):
        super().__init__()
        self.logo = util_img.leer_imagen("./interfaz 1/imagenes/logo.png", (900, 650))
        self.perfil = util_img.leer_imagen("./interfaz 1/imagenes/mercado.png", (100, 100))
        self.config_window()
        self.paneles()
    ...
    def config_window(self):
        ...
        self.title('Mercado')
        self.iconbitmap("./interfaz 1/imagenes/piña.ico")
        w, h = 1024, 600
    ...
    def controles_barra_superior(self):
        ...
        self.labelUsuario = tk.Label(self.barra_superior, text="Felipe Mantilla")
